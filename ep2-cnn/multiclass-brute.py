...
output_loc = "./results-multiclass-brute/"
input_shape = (28, 28, 1)
...
prep_time = end_time_prep - start_time_prep
print(f'Brute prep time: {prep_time}')
train_time = end_time_training - start_time_training
print(f'Training time: {train_time}')

infos = {
    'Data prep time': f'{prep_time}',
    'Training time': f'{train_time}',
    'Total time': f'{prep_time + train_time}',
    'Accuracy': f'{accuracy}'
}
